 ...
 * e atualizar tasks e agendar notificações na fila de notificações por email.
 *
...
class TasksMessageListener(
    ...
    /**
     * Esta função ira receber um [TaskModel] guardar no banco de dados,
     * atualizar se já existir e agendar uma notificação por email.
     */
    @Transactional
    ...
    /**
     * Esta função ira atualizar uma task existente e remarcar uma notificação
     * caso o termino da tarefa seja alterado.
     */
    ...
    /**
     * Esta função ira agendar uma tarefa atraves de uma fila no RabbitMQ
     */
